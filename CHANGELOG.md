...
- Adding Vercel analytics! [(issue #327)](https://github.com/jake-kelley/ff-league-page/issues/327)
...
- Fixed full blog post bug [(issue #341)](https://github.com/jake-kelley/ff-league-page/issues/341)
...
- Fixed duplicated playoff stat issue. [(issue #315)](https://github.com/jake-kelley/ff-league-page/issues/315)
...
- Resorces page wouldn't load. [(issue #296)](https://github.com/jake-kelley/ff-league-page/issues/296)
- Sleeper now include median match in standings API, so we ended up double counting. Removed the median match logic [(issue #272)](https://github.com/jake-kelley/ff-league-page/issues/296) and [(issue #276)](https://github.com/jake-kelley/ff-league-page/issues/276)
- In playoff matches, the bye weeks had a non-valid manager ID whick broke due to poor error handling [(issue #289)](https://github.com/jake-kelley/ff-league-page/issues/289)
- Vercel was weirdly tring to force node 20 despite the fact that Vercel doesn't support node 20 [(issue #294)](https://github.com/jake-kelley/ff-league-page/issues/294)
...
- Users were unable to add comments. [(issue #268)](https://github.com/jake-kelley/ff-league-page/issues/268)
...
- Add positional key to rosters. [(enhancement #261)](https://github.com/jake-kelley/ff-league-page/issues/261)
...
- Auction leagues weren't correctly displaying the bid amount. [(issue #254)](https://github.com/jake-kelley/ff-league-page/issues/254)
...
- If a league did multiple drafts in the same season (startup and rookie for example), only the most recent was displayed. This ensures that all drafts from a particular season are displayed. [(issue #240)](https://github.com/jake-kelley/ff-league-page/issues/240)

## [2.2.7] - 2023-08-21

### Fixed

- Some matchups only had one team in the matchup (playing themselves ????), which caused bugs in any page that touched league records [(issue #244)](https://github.com/jake-kelley/ff-league-page/issues/244)
...
- Fix resources bug. NBC Sports Edge API no longer works and was breaking the resources page [(issue #230)](https://github.com/jake-kelley/ff-league-page/issues/230)
...
- Fix edge case from transactions in the calendar year before the first fantasy season [(issue #206)](https://github.com/jake-kelley/ff-league-page/issues/206)

- Fix navigation when clicking on rival [(issue #212)](https://github.com/jake-kelley/ff-league-page/issues/212)

- Fix page freeze on records > playoffs > season records [(issue #213)](https://github.com/jake-kelley/ff-league-page/issues/213)

- Fix standings page during preseason [(issue #221)](https://github.com/jake-kelley/ff-league-page/issues/221)

### Changed

- Use name from managers array (if available) instead of username [(issue #227)](https://github.com/jake-kelley/ff-league-page/issues/227)

## [2.2.1] - 2023-04-30

### Fixed

- Fix the error thrown on the rivalry page when the pevious league ID is 0 [(issue #204)](https://github.com/jake-kelley/ff-league-page/issues/204)
...
- Added the all new Rivalry page! ([(feature #160)](https://github.com/jake-kelley/ff-league-page/issues/160) & [(issue #181)](https://github.com/jake-kelley/ff-league-page/issues/181))
...
- Fix error thrown when no blog is present [(issue #202)](https://github.com/jake-kelley/ff-league-page/issues/202)
...
- Fix standings order issue[(issue #199)](https://github.com/jake-kelley/ff-league-page/issues/199)
    - Turn rosters into a map instead of an array in order to deliver the correct data
...
- Rankings are now organize by manager instead of team! [(issue #164)](https://github.com/jake-kelley/ff-league-page/issues/164)
    ...
    - **To take full advantage of this you need to add managerIDs to the managers object in leagueInfo`src/lib/utils/leagueInfo.js`**
        - More instructions in the updated [Training Wheels managers instructions](https://github.com/jake-kelley/ff-league-page/blob/master/TRAINING_WHEELS.md#2-add-managers)
- Use league specific avatar if avilable [(issue #156)](https://github.com/jake-kelley/ff-league-page/issues/156)

### Fixed

- Standings order issue [(issue #179)](https://github.com/jake-kelley/ff-league-page/issues/179)
...
- Updated TRAINING WHEELS re: blog instructions [(issue #166)](https://github.com/jake-kelley/ff-league-page/issues/166)

## [2.0.0] - 2022-09-18

### Changed

- Upgraded Vite and SvelteKit [(issue #149)](https://github.com/jake-kelley/ff-league-page/issues/149)
    - **This may be a breaking change. It required a very significant rewrite**

### Fixed

- Blog being anabled crashing pages [(issue #141)](https://github.com/jake-kelley/ff-league-page/issues/141)
- Support images and tables in blogs [(issue #140)](https://github.com/jake-kelley/ff-league-page/issues/140)
    - **This is a breaking change for previous blog integrations as it now requires an additional API key!!**
    - Follow the README or [TRAINING_WHEELS](https://github.com/jake-kelley/ff-league-page/blob/master/TRAINING_WHEELS.md#iii-add-a-blog) guide to add the additional key and re-enable your blog
- Roster ID mismatch [(issue #155)](https://github.com/jake-kelley/ff-league-page/issues/155)

## [1.3.4] - 2022-07-09

### Fixed

- NBC Sports Edge changed it's API format which introduced a bug that broke the Resources page [(issue #129)](https://github.com/jake-kelley/ff-league-page/issues/129)

## [1.3.3] - 2022-05-29

### Fixed

- Empty points were causing a bug in the rankings page. Also, the standings page is throwing an undefined in the preseason. [issue #119](https://github.com/jake-kelley/ff-league-page/issues/119)

## [1.3.2] - 2022-05-20

### Fixed

- When clicking on a manager from the managers page, the manager indefinitely loads. [issue #117](https://github.com/jake-kelley/ff-league-page/issues/117)
    - RC: [PR #114 Adds playoff records and rankings to the records page](https://github.com/jake-kelley/ff-league-page/pull/114)

## [1.3.1] - 2022-04-28

### Fixed

- Scroll to was not functioning properly on the constitution page, reported in [issue #109](https://github.com/jake-kelley/ff-league-page/issues/109)
...
- Playoff records and rankings [feature suggestion #80](https://github.com/jake-kelley/ff-league-page/issues/80)
...
- Brackets now account for two week per round leagues [issue #97](https://github.com/jake-kelley/ff-league-page/issues/97)
...
- Trophies page bug reported in [issue #95](https://github.com/jake-kelley/ff-league-page/issues/95)
...
- PPG Records [#92](https://github.com/jake-kelley/ff-league-page/issues/92)
    - Big thank you to [OldNewsBlues](https://github.com/OldNewsBlues) for implementing this
...
- Bug that affects playoff matchup and standings 
    - Reported in issue [#98](https://github.com/jake-kelley/ff-league-page/issues/98)
...
- Bug that affects the draft page of keeper leagues 
    - Reported in issue [#85](https://github.com/jake-kelley/ff-league-page/issues/85)

## [1.2.6] - 2021-10-07

### Added

- Docker support to address feature request [#68](https://github.com/jake-kelley/ff-league-page/issues/68)
...
- Bug in records
    - When the records tab was left and returned to multiple times, the total points column would eventually become NaN (as reported in issue [#77](https://github.com/jake-kelley/ff-league-page/issues/77) by [OldNewsBlues](https://github.com/OldNewsBlues))
...
- Bug in records
    - Inverse of the correct week was shown (as reported in issue [#77](https://github.com/jake-kelley/ff-league-page/issues/77) by [OldNewsBlues](https://github.com/OldNewsBlues))
...
- :warning: WARNING !:warning:
    ...
    - Please refer to the [Training Wheels blog instructions](https://github.com/jake-kelley/ff-league-page/blob/master/TRAINING_WHEELS.md#iii-add-a-blog) to see how to get the new API key (and then replace the old environment variable with the new one)
...
- For directions, follow the [Training Wheels blog instructions](https://github.com/jake-kelley/ff-league-page/blob/master/TRAINING_WHEELS.md#iii-add-a-blog)
...
- Fix for [issue #57](https://github.com/jake-kelley/ff-league-page/issues/57)
...
- Fixed bug with the trade arrows on the manager page, the bug was introduced in [pr #55](https://github.com/jake-kelley/ff-league-page/pull/55)

## [1.0.8] - 2021-09-08

### Fixed

- Fixed bug in manager pages introduced in [pr #55](https://github.com/jake-kelley/ff-league-page/pull/55)
...
- Reversal round support
    ...
    - [PR #51](https://github.com/jake-kelley/ff-league-page/pull/51)
...
- Some league rosters return null for the players, which breaks power rankings and the rosters page
    - Bug reported in [issue #49](https://github.com/jake-kelley/ff-league-page/issues/49)
