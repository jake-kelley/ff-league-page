...
*A primer for new and incoming managers — ~10 minute read.*
...
2. **The dynasty market behaves like a stock market.** "Buy low, sell high" is a real edge, not a cliché. Identifying a player's peak value and selling at that point can turn one stud into two or three.
3. **There are three valid postures: contend, retool, rebuild.** Pick one explicitly each offseason. The single worst place to be is the murky middle — "I'm pretty good but not great" — because you accumulate aging vets without ever cashing them in for picks.
...
### 🎯 Quarterback — longest shelf life

- Peak: 28-32. Most elite QBs hold up through 35.
- Cliff: ~36-37 for arm-talent QBs; ~33-34 for run-first QBs.
- A top-12 QB can be a startable asset for 8-12 years — the longest shelf life of any position.
...
- TE values lag WR/RB hype curves — waiting on year-2 TEs is profitable since many can be bought cheap during their year-2/3 trough.
...
> 🔮 **The "Two Year" rule.** When projecting an asset's dynasty value, picture them at +2 years. RB at 25 = solid; +2 = 27, getting risky. WR at 25 = peaking; +2 = 27, still elite. The two-year delta tells you whether you're buying or selling.

## 🔄 4. The Three Phases: Win-Now, Reload, Rebuild
...
### ⏱️ The 5-Week Assessment

By Weeks 4-6 you have enough data to know your team. If you're 1-4 with old vets and middling production — sell. If 4-1 with surging young pieces — hold and stockpile next year's picks. If 2-3 — *decide within two weeks*: contender or seller. The middle is the most expensive place to be.
...
Active trading is the single most-cited difference between owners who win multi-year titles and owners who don't. Passive owners lose 10-20% of relative roster value yearly — not from any one mistake, but from the compounding cost of *never* moving aging vets, never converting depth into upside, never exploiting another manager's panic.

### 🏁 What Winners Do

- Trade frequently. Target 5-10 trades per season minimum.
- Always know their next 2-3 trade candidates on their roster — the players they'd actively shop.
...
1. **Undervaluing rookie picks** — especially future picks. 2027's 1st in May 2026 is a discount asset.
2. **Over-trading for youth** at the expense of a competing roster. Rebuilding without a plan to ever compete.
3. **Stuck in the middle** — neither contender nor rebuilder. The most expensive place to be.
...
- Eternal rebuild — 5+ years of "rebuilding" without ever pivoting to contend. Set milestones; pivot when met.

## 📚 9. Glossary of Dynasty Terms

- **ADP** — Average Draft Position. Where a player gets drafted on average across leagues.
- **Age Cliff** — The age at which a player's production sharply drops. RB ~27-28; WR ~30; TE ~31-32; QB ~36-37.
- **Asset** — Any tradable resource: player or pick.
- **Bell Cow** — An RB getting the majority of touches. Workhorse role.
- **Blue Chip** — Top-tier elite player with proven production and long career window.
- **BPA** — Best Player Available drafting strategy.
- **Buy Low** — Acquiring a player at a temporarily depressed value.
- **Calc** — Trade calculator (KTC, FantasyCalc, DLF, etc.). The Trade Calculator on this site uses FantasyCalc values.
- **Consolidation** — Trading multiple pieces for one better player. 2-for-1, 3-for-1.
- **Contender** — Team with realistic championship odds in the current/next season.
- **Dominator Rating** — Market share metric for college players.
- **Dump Truck** — A rebuilder unloading vets en masse. The owner you want to call when you're a contender.
- **Early 1st / Mid 1st / Late 1st** — 1.01-1.04 / 1.05-1.08 / 1.09-1.12 rookie pick slots.
- **FAAB** — Free Agent Acquisition Budget. The bidding system for waivers (this league: $100 per season).
- **Glue Guy** — Mid-tier reliable starter without star power.
- **Handcuff** — Backup RB whose value depends on the starter getting hurt.
- **Hero RB** — Strategy of taking one elite RB and waiting on the others.
- **KTC** — KeepTradeCut, a popular crowdsourced player-value site.
- **Liquidity** — How easily an asset can be traded at fair value.
- **Lottery Ticket** — Cheap stash with high upside potential.
- **NFL Draft Capital** — Where a player was drafted by their NFL team. Strongest pre-rookie predictor of fantasy success.
- **Orphan** — Dynasty team abandoned by a previous owner; needs a new manager.
- **Pick Capital** — Quantity and quality of picks owned.
- **Pivot** — Switching from one phase to another (contender to rebuilder, or vice versa).
- **Post-Hype Sleeper** — A year-3-to-5 player who hasn't broken out but might.
- **Rebuild** — Strategic teardown for a future championship.
- **Reload** — Mid-pack retooling for near-term contention without a full teardown.
- **Rookie Pick** — A draft slot in an upcoming rookie draft. Tradable up to 3 drafts in advance.
- **Sell High** — Trading at peak value.
- **Studs Win Trades** — The mantra: in a 2-for-1 or 3-for-1, the side getting the best single player almost always wins long-term.
- **Tier** — Group of similarly-valued players. The gaps between tiers (tier breaks) signal trade timing.
- **Tilt** — Emotional state after losses; a bad time to trade.
- **Trade Back / Trade Up** — Trading down for additional picks (back) or trading multiple picks for a higher slot (up).
- **Workhorse** — RB getting 80%+ of his team's touches.
- **YAC** — Yards After Catch.
- **YPRR** — Yards per Route Run. Top efficiency metric for WRs.
- **Zero RB** — Strategy of skipping RB early in the draft and loading up on WRs/TE.
